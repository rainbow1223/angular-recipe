...
export class RecipeService{
    ...
    recipes: Recipe[] = [new Recipe('Test Recipe', 'This is a test recipe', 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTDXt5sxxzVL6WzcHPpwfywcqGOCtNw0Fkm9uDZEVEShUWk2a7JkM9fHw&s=0', [new Ingredients('Meat', 1), new Ingredients('Chef', 1)]), 
